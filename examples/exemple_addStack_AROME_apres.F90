...
temp (REAL, ZTLK, (D%NIJT,D%NKT)) 
temp (REAL, ZRT, (D%NIJT,D%NKT)) 
temp (REAL, ZL, (D%NIJT,D%NKT)) 
temp (REAL, ZLV, (D%NIJT,D%NKT)) 
temp (REAL, ZLS, (D%NIJT,D%NKT)) 
temp (REAL, ZCPD, (D%NIJT,D%NKT)) 
YLSTACK=YDSTACK 
alloc (ZTLK) 
alloc (ZRT) 
alloc (ZL) 
