...
REAL, DIMENSION(:,:), ALLOCATABLE :: ZTLK 
REAL, DIMENSION(:,:), ALLOCATABLE :: ZRT 
REAL, DIMENSION(:,:), ALLOCATABLE :: ZL 
REAL, DIMENSION(:,:), ALLOCATABLE :: ZLV 
REAL, DIMENSION(:,:), ALLOCATABLE :: ZLS 
REAL, DIMENSION(:,:), ALLOCATABLE :: ZCPD 
ALLOCATE(ZTLK(D%NIJT,D%NKT)) 
ALLOCATE(ZRT(D%NIJT,D%NKT)) 
ALLOCATE(ZL(D%NIJT,D%NKT)) 
ALLOCATE(ZLV(D%NIJT,D%NKT)) 
ALLOCATE(ZLS(D%NIJT,D%NKT)) 
ALLOCATE(ZCPD(D%NIJT,D%NKT)) 
JIJ=D%NIJB
!
!-------------------------------------------------------------------------------
!
